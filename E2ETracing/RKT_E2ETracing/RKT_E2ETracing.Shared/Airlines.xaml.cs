...
namespace RKT_E2ETracing
{
    ...
    public sealed partial class Airlines : Page
    {
        ...
        private async void AppBarButtonUploadLogsClick(object sender, RoutedEventArgs e)
        {
            string message = null;
            ...
            {
                await new Windows.UI.Popups.MessageDialog("Successfully uploaded client logs").ShowAsync();
            }
        }
