namespace RKT_WPF_GETFlights.Contexts
{
    using System;
    ...
    public class ODataContext : INotifyPropertyChanged
    {
        ...
        public ODataContext(string serviceUrl)
        {
            ...
            // TODO: Change 2 - Creating a new instance of ODataStore
        ...
        public async System.Threading.Tasks.Task DownloadCollection(string collectionName)
        {
            try
            {
                ...
                // TODO: Change 4 - Submitting GET request to retrieve data for specified collection
        ...
        public async System.Threading.Tasks.Task DownloadRelatedItems(string navigationPropertyName)
        {
            ...
            try
            {
                ...
                // TODO: Change 5 - Submitting GET request to retrieve data for a related item (Use either one of the code snippet)
                // DO NOT USE BOTH
