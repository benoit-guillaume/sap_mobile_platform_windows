...
namespace RKT_E2ETracing
{
    ...
    public sealed partial class Flights : Page
    {
        ...
        {
            var entity = (SAP.Data.OData.IODataEntity)this.ItemGridView.SelectedItem;
            ...
            else if (!this.Frame.Navigate(typeof(FlightDetails), null))
            {
        ...
        {
            this.Btn_Status.Visibility = (((ListViewBase)sender).SelectedItem != null) ? Visibility.Visible : Visibility.Collapsed;
        }
