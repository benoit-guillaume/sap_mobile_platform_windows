...
using RKT_GETFlights.Common;
using RKT_GETFlights.Contexts;
using RKT_GETFlights.Helpers;
...
namespace RKT_GETFlights
{
    ...
    public sealed partial class Airlines : Page
    {
        ...
        private async void BtnShowFlightsClick(object sender, RoutedEventArgs e)
        {
            ...
            else if (!Frame.Navigate(typeof(Flights), null))
            {
