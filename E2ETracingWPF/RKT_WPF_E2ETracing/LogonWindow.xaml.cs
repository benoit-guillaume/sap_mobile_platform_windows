...
namespace RKT_WPF_E2ETracing
{
    ...
    {
        public readonly LogonPageContext pageContext = new LogonPageContext();
        ...
        {
            // TODO: Change 4 - Logging messages locally on device file system
            //LoggingContext.Context.Logger.LogInfo("E2ETracing - Entering state: " + state);
        ...
        {
            // TODO: Change 3 - Creating new SupportabilityContext
            //if (LoggingContext.Context == null)
            //{
            //    LoggingContext.Context = new SupportabilityContext();
            //}
